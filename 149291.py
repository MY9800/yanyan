...
class Teacher(Person):
    def__init__(self,name='',age=30,sex='man',department='Computer'):
...
if__name__=='__main__':
    ...
    lisi=Teather('Li si','32','man','Math')
    lisi.show()
    lisi.setAge(40)
    lisi.show()
...
class myDeque:
    def__init__(self,iterable=None,maxlen=10):
        if iterable==None:
            self._content=[]
            self._current=0
        else:
